...
function CreatePlan() {
  ...
  async function handleCreatePlan() {
    ...
    try {
      setIsLoading(true);
      setMessage("Generating your personalized study plan. This may take a moment...");
      setMessageType("info");
  ...
  return (
    <div>
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-2">Create a Study Plan</h2>
        <p className="text-gray-600">Tell us what you want to learn, and our AI will generate a personalized study plan for you.</p>
      </div>
        ...
        <div className="lg:col-span-2">
          <div className="card p-6">
            <div className="space-y-6">
              ...
              <div>
                <label htmlFor="goal" className="form-label">Learning Goal</label>
                <textarea
                  id="goal"
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Be specific about what you want to learn. The more details you provide, the better your plan will be.
                </p>
              </div>
          ...
          <div className="mt-6 bg-yellow-50 rounded-lg p-4 border border-yellow-200">
            <h3 className="font-medium text-yellow-800 mb-2">Tips for a Great Study Plan</h3>
            <ul className="text-sm text-yellow-700 space-y-1">
              ...
              <li>• Specify if you need resources for a specific skill level</li>
            </ul>
          </div>
        </div>
          ...
          {planOutput ? (
            <div>
              <div className="flex justify-between items-center mb-4">
                ...
                <Link to="/study-plans" className="text-sm text-primary-600 hover:text-primary-800">
                  View All Plans →
                </Link>
              </div>
            ...
            <div className="bg-gray-50 rounded-lg border-2 border-dashed border-gray-300 p-8 text-center h-full flex items-center justify-center">
              <div>
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900">No study plan yet</h3>
                <p className="mt-1 text-sm text-gray-500">
                  Fill out the form and click "Generate & Save Plan" to create your personalized study plan.
                </p>
              </div>
            </div>
          )}
